# salami - a book reader capable of reading simple stories and answering the stories

# directory
setwd("C:\\Users\\stanley\\Desktop\\MISCELLANEOUS R\\ml projects\\salami reader")
